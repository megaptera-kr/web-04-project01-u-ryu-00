    ...
    public CrowdedPanel(List<Review> firstStoreReviews, List<Review> secondStoreReviews, List<Review> proofReviews, List<Review> nightReviews, List<Review> moneyReviews, List<Review> lossReviews, List<Review> seinoReviews, List<Review> fatherReviews, List<Review> backingReviews, List<Review> workReviews) {
        ...
        button3.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2015년 03월 30일 " +
                    "<br>쪽수: 177쪽" +
                    "<br>책 소개: 만약 네가 먼저 죽는다면 나는 너를 먹을 거야." +
                    "<br>그래야 너 없이도 죽지 않고 살 수 있어." +
                    "<br>사랑 후 남겨진 것들에 관한 숭고할 만큼 아름다운 이야기" +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button4.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2021년 02월 03일 " +
                    "<br>쪽수: 144쪽" +
                    "<br>책 소개: 가족들과 함께 자연 속에서 행복하게 살았지만 무분별한 남획으로 세상에 혼자 남게 된 흰바위코뿔소 '노든'" +
                    "<br>태어나자마자 코뿔소의 손에 남겨진 어린 펭귄. 어린 펭귄을 바다에 데려다 주겠다는 약속을 지키기 위해 떠난" +
                    "<br>동물들의 여정 속에서 어둡게만 보이는 현실 속 희망을 발견한다." +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button5.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2020년 06월 15일 " +
                    "<br>쪽수: 415쪽" +
                    "<br>책 소개: [알면서도 알지 못하는 것들] 김승호 회장의 최신간. 유튜브에서 1,600만 명이 시청한 <돈의 속성> 완결편으로 책을 출간했다." +
                    "<br>복잡하고 어려운 내용은 없다. 그저 자신이 가장 잘할 수 있고, 잘 아는 '돈 버는' 모든 것을 명료하게 풀었다." +
                    "<br>하나의 인격체와 같은 돈, 그동안 내가 알던 돈에 관한 생각을 과감히 수정한다." +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button6.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2023년 03월 17일 " +
                    "<br>쪽수: 412쪽" +
                    "<br>책 소개: (닫힌 문을 기꺼이 열고 기회로 나아가는 법) 30년 경력의 저널리스트였던 저자는 어느 날 뇌졸중으로 한쪽 시력을 잃는다." +
                    "<br>연인은 떠나고, 아버지는 알츠하이머 진단을 받았다." +
                    "<br>이 불행들이 닫은 문들을 흐린 한쪽 눈으로 기꺼이 열고 기쁨의 빛을 향해 나아간다." +
                    "<br>내게 닫힌 문들을 열고 갈 용기를 줄 책" +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button7.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2023년 03월 02일 " +
                    "<br>쪽수: 736쪽" +
                    "<br>책 소개: 2000년부터 발표된 그의 주옥같은 글들." +
                    "<br>독자들이 자발적으로 만든 제본서는 물론, 전자책과 앱까지 나왔던 [세이노의 가르침]이 드디어 전국 서점에서 독자들을 마주한다." +
                    "<br>여러 판본을 모으고 저자의 확인을 거쳐 최근 생각을 추가로 수록하였다. " +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button8.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2022년 09월 02일 " +
                    "<br>쪽수: 268쪽" +
                    "<br>책 소개: (죽음에서 시작하는 삶의 이야기) '아버지가 죽었다.'는 문장으로 소설은 시작한다." +
                    "<br>'전직 빨치산'인 아버지의 죽음 이후 장례를 치르는 3일간, 오고 가는 사람과 말들 속에 그의 시대가 촘촘하게 얽혀있다." +
                    "<br>읽는 동안 울컥, 깊이 맺혀있던 마음들이 토해져 나와 울다가 웃다가 그래서 따뜻해지는 삶의 이야기" +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button9.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2022년 05월 30일 " +
                    "<br>쪽수: 314쪽" +
                    "<br>책 소개: 단 20편의 영상으로 10만 구독자를 넘어서며 화제를 모았던 라이프해커 자청의 첫 책이다." +
                    "<br>가난을 넘어 경제적 자유와 행복을 얻기까지 저자가 찾아낸 7단계의 성공 원리를 담고 있다." +
                    "<br>고정관념을 넘어 인생을 레벨업하고 싶다면 저자의 성공 방식을 만나고 실행해 보자." +
                    "</html>");
            panel.add(bookInformationLabel);
        ...
        button10.addActionListener((event) -> {
            ...
            JLabel bookInformationLabel = new JLabel("<html>" +
                    "발행일 : 2023년 02월 28일 " +
                    "<br>쪽수: 320쪽" +
                    "<br>책 소개: 챗GPT라는 생성형 인공지능의 등장에 전 세계의 이목이 쏠리고 있다." +
                    "<br>어려운 질문에도 답을 척척 내놓고, 소설이나 광고카피도 술술 써내는 인공지능으로 인해" +
                    "<br>주식 시장이 요동치고 내 일자리는 과연 무사할지 걱정의 목소리도 높아졌다." +
                    "<br>그런데 아이러니하게도 챗GPT의 등장으로 인해 인공지능이 따라올 수 없는 인간의 능력이 주목받고 있다." +
                    "<br>바로 '문해력'이다. [일머리 문해력]은 그중에서도 직장이나 비즈니스 상황 등 사회생활에서 필요한 문해력을 키우는 법을 알려주는 책이다." +
                    "</html>");
            panel.add(bookInformationLabel);
